    ...
    >
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        {OPTIONAL_SECTIONS.map((section) => {
          const isEnabled =
            formData?.[section.id]?.enabled === true
